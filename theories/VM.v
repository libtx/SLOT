...
Section VM.
  ...
  Section handle_reply.
    ...
    Definition handle_io_reply := pure handle_io_reply_morph handle_io_reply_covariance.
  End handle_reply.

  Definition process_io_morph pid mb_t (req : Request) (next : Reply req -> Program mb_t) : MFunRet (Reply req) VM :=
    handle_io_reply mb_t pid next ∘ lift_w_ret (h_handler pid req).
